...
console.log("                                                                         ")
function versionsReleaseInYear(year) {
    ...
    console.table(releasedProductVersions);
    console.log("__________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ ")
}
versionsReleaseInYear("2010")

//In which release the specific bug id is present
console.log("                                                                         ")
function bugsInVersion(bugIn) {
    count = 0
...
function mostUpdatesByAuthor() {
    ...
    author_version = 0
    max_value = 1
    for (i = 0; i < author_update.length; i++) {
        for (j = 1; j < author_update.length; j++) {
...
console.log("                                                                         ")
function otherTypeOfProduct(majors) {
    ...
    console.table(majortype);
    console.log("__________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ ");
}
otherTypeOfProduct("Major")

console.log("                                                                         ")
function featuresOftheProduct (specification){
...
console.log(`Features : ${specification}`)
console.table(updatefeatures)
    console.log("__________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ __________ ");
}
